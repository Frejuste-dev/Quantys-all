...
from models.inventory_item import InventoryItem  # Import explicite pour s'assurer que le modèle est chargé
...
def get_url():
    """Construire l'URL de la base de données depuis les variables d'environnement"""
